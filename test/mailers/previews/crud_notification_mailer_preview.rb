...
class CrudNotificationMailerPreview < ActionMailer::Preview
  ...
  # Preview this email at http://localhost:3000/rails/mailers/crud_notification_mailer/creat_notification
  def creat_notification
    CrudNotificationMailer.creat_notification
  end
